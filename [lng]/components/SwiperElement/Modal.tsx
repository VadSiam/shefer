...
const ImageModal: React.FC<IImageModal> = ({ image, onClose, show, title }) => {
  console.log('🚀 ~ file: Modal.tsx:2 ~ show:', show)
  ...
  return (
    <div
      ...
      tabIndex={-1}
      aria-hidden="true"
      className="flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full backdrop-blur-md"
    >
      <div
        ref={modalRef}
      ...
      >
        {/* <!-- Modal content --> */}
        <div className="relative bg-inherit rounded-lg shadow dark:bg-inherit">
          {/* <!-- Modal header --> */}
